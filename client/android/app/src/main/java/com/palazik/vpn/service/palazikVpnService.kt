...
class palazikVpnService : VpnService() {
     ...
     * condition for keeping an already-running TUN alive. In particular a cold
    ...
    /** Probe URLs sequentially so a cold phone does not perform several handshakes at once. */

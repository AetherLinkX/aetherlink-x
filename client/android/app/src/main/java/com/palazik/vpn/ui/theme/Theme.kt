...
private fun cyberDarkScheme() = darkColorScheme(
    ...
    secondaryContainer = Color(0xFF251643),
    onSecondaryContainer = CyberOnSurface,
    tertiaryContainer  = Color(0xFF073D33),
    onTertiaryContainer = Color(0xFFB5F3DF),
    outline            = CyberOutline,
    outlineVariant     = Color(0xFF241D3A),
)

private fun cyberLightScheme() = lightColorScheme(
    primary            = Color(0xFF6936F5),
    onPrimary          = Color.White,
    primaryContainer   = Color(0xFFE7DEFF),
    onPrimaryContainer = Color(0xFF201050),
    secondary          = Color(0xFF8657E8),
    onSecondary        = Color.White,
    secondaryContainer = Color(0xFFEDE4FF),
    onSecondaryContainer = Color(0xFF251447),
    tertiary           = Color(0xFF008C70),
    onTertiary         = Color.White,
    tertiaryContainer  = Color(0xFFD1F5EA),
    onTertiaryContainer = Color(0xFF00382C),
    background         = Color(0xFFFAFAFF),
    onBackground       = Color(0xFF171426),
    surface            = Color(0xFFFFFFFF),
    onSurface          = Color(0xFF171426),
    surfaceVariant     = Color(0xFFF1EDFC),
    onSurfaceVariant   = Color(0xFF554E69),
    outline            = Color(0xFF8D81AA),
    outlineVariant     = Color(0xFFD5CEE7),

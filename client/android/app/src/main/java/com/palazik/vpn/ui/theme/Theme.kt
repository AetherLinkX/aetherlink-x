...
private fun cyberDarkScheme() = darkColorScheme(
    ...
    tertiary           = Color(0xFFD45CFF),
    background         = CyberBackground,
    surface            = CyberSurface,
    surfaceVariant     = CyberSurfaceVariant,
    onSurface          = CyberOnSurface,
    onSurfaceVariant   = Color(0xFFCFC2D8),
    outline            = CyberOutline,
    outlineVariant     = Color(0xFF5A4864),
)

private fun cyberLightScheme() = lightColorScheme(
    primary            = Color(0xFF6B00A8),
    onPrimary          = Color.White,
    primaryContainer   = Color(0xFFEEDBFF),
    onPrimaryContainer = Color(0xFF26003D),
    secondary          = Color(0xFF625B71),
    onSecondary        = Color.White,
    secondaryContainer = Color(0xFFE8DEF8),
    onSecondaryContainer = Color(0xFF1D192B),
    tertiary           = Color(0xFF7D1FA2),
    onTertiary         = Color.White,
    tertiaryContainer  = Color(0xFFF5D9FF),
    onTertiaryContainer = Color(0xFF310044),
    background         = Color(0xFFF9F5FC),
    onBackground       = Color(0xFF1D1A20),
    surface            = Color(0xFFFFFBFF),
    onSurface          = Color(0xFF1D1A20),
    surfaceVariant     = Color(0xFFECE3EF),
    onSurfaceVariant   = Color(0xFF4D4351),
    outline            = Color(0xFF766C7A),
